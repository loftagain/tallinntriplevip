            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nickname" class="col-md-4 col-form-label text-md-end">{{ __('messages.Nickname') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-end">{{ __('messages.Country') }}</label>
                            <div class="col-md-6">
